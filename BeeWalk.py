...
plt.title("Figure 1: Total Bee Counts Over the Years")
plt.xlabel("Year")
...
g.fig.suptitle("Figure 2: Seasonal Bee Counts Over the Years", fontsize=16)
...
plt.title("Figure 3: Heatmap of Extreme Heat Events by Year and Season")
plt.xlabel("Season")
plt.ylabel("Year")
...
plt.title("Figure 4: Heatmap of Extreme Cold Events by Year and Season")
plt.xlabel("Season")
plt.ylabel("Year")
...
plt.title("Figure 5: Trends in Bee Counts with Extreme Events Highlighted")
plt.xlabel("Year")
...
plt.title("Figure 6: Comparison of Bee Counts for Extreme vs Non-Extreme Events")
plt.xlabel("Season")
plt.ylabel("Bee Counts")
plt.legend(title="Event Type")
plt.grid(True)
